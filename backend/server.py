...
async def seed_database(username: str, password: str):
    ...
    # Initial Products Data - matches Product model schema
    initial_products = [
        ...
        {"id": str(uuid.uuid4()), "name": "Wheatgrass Microgreens", "benefit": "Classic superfood for juicing and smoothies. Rich in chlorophyll and detoxifying.", "nutrients": "Vitamins: A, C, E | Minerals: Iron, Calcium, Magnesium | Chlorophyll: Very High", "price": 140.0, "growth_days": 10, "stock": 50, "active": True, "image": "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?crop=entropy&cs=srgb&fm=jpg&q=85", "created_at": datetime.now(timezone.utc).isoformat()},
    ]
