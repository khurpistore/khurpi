...
class _LoginPageState extends ConsumerState<LoginPage> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: authState?.isLoading == true ? null : _submit,
  ...
  Future<void> _submit() async {
    ...
    bool success;
    if (_isLogin) {
      success = await ref.read(provideAuthViewModelNotifierProvider)!.login(phone, password);
    } else {
      success = await ref.read(provideAuthViewModelNotifierProvider)!.register(name, phone, password);
    }
