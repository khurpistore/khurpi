                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      IconButton(onPressed: () => ref.read(provideProductDetailViewModelNotifierProvider)!.decrementQuantity(), icon: const Icon(Icons.remove)),
                                      Text('${state.quantity} ${state.selectedUnit}', style: AppTextStyles.body.copyWith(fontWeight: FontWeight.w600)),
                                      IconButton(onPressed: () => ref.read(provideProductDetailViewModelNotifierProvider)!.incrementQuantity(), icon: const Icon(Icons.add)),
                                    ],
                                  ),
                                ),
