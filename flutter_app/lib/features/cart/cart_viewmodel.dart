...
part '../../generated/features/cart/cart_viewmodel.freezed.dart';
part '../../generated/features/cart/cart_viewmodel.g.dart';
...
class CartViewModel extends _$CartViewModel {
  ...
  Future<void> clearCart() async {
    try {
      ...
      await _sharedPreferences.remove('last_spin_order_id');
