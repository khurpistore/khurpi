...
mixin _$CartItemModel {
 ...
 String get productId; String get productName; double get price; double? get wholesalePrice; String? get imageUrl; double get quantity; String get unit;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,productId,productName,price,wholesalePrice,imageUrl,quantity,unit);

@override
String toString() {
  return 'CartItemModel(productId: $productId, productName: $productName, price: $price, wholesalePrice: $wholesalePrice, imageUrl: $imageUrl, quantity: $quantity, unit: $unit)';
}
...
@useResult
$Res call({
 String productId, String productName, double price, double? wholesalePrice, String? imageUrl, double quantity, String unit
});
...
/// Create a copy of CartItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? productId = null,Object? productName = null,Object? price = null,Object? wholesalePrice = freezed,Object? imageUrl = freezed,Object? quantity = null,Object? unit = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String productId,  String productName,  double price,  double? wholesalePrice,  String? imageUrl,  double quantity,  String unit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartItemModel() when $default != null:
return $default(_that.productId,_that.productName,_that.price,_that.wholesalePrice,_that.imageUrl,_that.quantity,_that.unit);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String productId,  String productName,  double price,  double? wholesalePrice,  String? imageUrl,  double quantity,  String unit)  $default,) {final _that = this;
switch (_that) {
case _CartItemModel():
return $default(_that.productId,_that.productName,_that.price,_that.wholesalePrice,_that.imageUrl,_that.quantity,_that.unit);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String productId,  String productName,  double price,  double? wholesalePrice,  String? imageUrl,  double quantity,  String unit)?  $default,) {final _that = this;
switch (_that) {
case _CartItemModel() when $default != null:
return $default(_that.productId,_that.productName,_that.price,_that.wholesalePrice,_that.imageUrl,_that.quantity,_that.unit);case _:
  return null;
...
class _CartItemModel implements CartItemModel {
  const _CartItemModel({required this.productId, required this.productName, required this.price, this.wholesalePrice, this.imageUrl, required this.quantity, this.unit = 'kg'});
...
/// Create a copy of CartItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? productId = null,Object? productName = null,Object? price = null,Object? wholesalePrice = freezed,Object? imageUrl = freezed,Object? quantity = null,Object? unit = null,}) {
