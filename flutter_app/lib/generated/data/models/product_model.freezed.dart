...
@JsonKey(name: 'id') String? get id;@JsonKey(name: '_id') String? get mongoId; String get name; String? get description; String? get benefit; double get price;@JsonKey(name: 'mrp') double? get mrp;@JsonKey(name: 'images') List<String>? get images;@JsonKey(name: 'wholesale_price') double? get wholesalePrice;@JsonKey(name: 'image_url') String? get imageUrl;@JsonKey(name: 'category_id') String? get categoryId;@JsonKey(name: 'category_name') String? get categoryName;@JsonKey(name: 'stock_status') String get stockStatus;@JsonKey(name: 'stock_quantity') int get stockQuantity; String? get unit; double? get weight;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
class _ProductModel extends ProductModel {
  const _ProductModel({@JsonKey(name: 'id') this.id, @JsonKey(name: '_id') this.mongoId, required this.name, this.description, this.benefit, required this.price, @JsonKey(name: 'mrp') this.mrp, @JsonKey(name: 'images') this.images, @JsonKey(name: 'wholesale_price') this.wholesalePrice, @JsonKey(name: 'image_url') this.imageUrl, @JsonKey(name: 'category_id') this.categoryId, @JsonKey(name: 'category_name') this.categoryName, @JsonKey(name: 'stock_status') this.stockStatus = 'out_of_stock', @JsonKey(name: 'stock_quantity') this.stockQuantity = 0, this.unit, this.weight, @JsonKey(name: 'is_active') this.isActive = true, @JsonKey(name: 'created_at') this.createdAt}): super._();
...
@override@JsonKey(name: 'images') final  List<String>? images;
